...
public class GeneradorItemsDesdeArchivoTest {
	...
	protected static final String tituloFormateadoEsperado  = "<section>"
						 											+ "<h1>El titulo</h1>"
					 												+ "<h2>El subtitulo</h2>"
																+ "</section>";
	protected static final String soloUnTituloFormateadoEsperado = "<section>" 
																	+ "<h1>Solo un titulo</h1>"
																+ "</section>";
	protected static final String soloTextoFormateadoEsperado =  "<section>"
																		+ "solo texto sin nada mas"
																	+ "</section>";

	protected static final String listaUnicaFormateadoEsperado =  "<section>"
																		+ "<ul>"
																			+ "<li>Un item de una lista</li>"
																			+ "<li>Otro item</li>"
																		+ "</ul>"													
																	+ "</section>";
	protected static final String primeraListaFormateadoEsperado =  "<section>"
			+ "<h1>Primera lista</h1>"
			+ "<ul>"
				+ "<li>Uno</li>"
				+ "<li>Dos</li>"
	...
	protected static final String segundaListaFormateadoEsperado =  "<section>"
			+ "<h1>Segunda lista</h1>"
			+ "<ul>"
				+ "<li>Tres</li>"
				+ "<li>Cuatro</li>"
	...
	protected static final String terceraListaFormateadoEsperado =  "<section>"
			+ "<ul>"
				+ "<li>Siete</li>"
				+ "<li>Ocho</li>"
			+ "</ul>"
	...
	public void seCreaListaDeItemsEntradaDelEjemploIntegrador() throws IOException {
		...
		Assert.assertEquals(soloUnTituloFormateadoEsperado, itemsEntradaObtenida.get(1).getTextoFormateado(formateadorHTML));
		Assert.assertEquals(soloTextoFormateadoEsperado, itemsEntradaObtenida.get(2).getTextoFormateado(formateadorHTML));
	...
	public void seCreaListaDeItemsConEncabezadoSinSeccion() throws IOException {
		...
		GeneradorItemsDesdeArchivo generadorItemsDesdeArchivo = new GeneradorItemsDesdeArchivo("src/test/resources/ejemploConEncabezadoSinSeccion.md");
		Formateador formateadorHTML = new FormateadorHTML();
		
		List<ItemEntrada> itemsEntradaObtenida = generadorItemsDesdeArchivo.getItemsEntrada(formateadorHTML);

		Assert.assertEquals(4, itemsEntradaObtenida.size());
		Assert.assertEquals(encabezadoFormateadoEsperado, itemsEntradaObtenida.get(0).getTextoFormateado(formateadorHTML));
	...
	public void seCreaListaDeItemsConBullets() throws IOException {
		...
		GeneradorItemsDesdeArchivo generadorItemsDesdeArchivo = new GeneradorItemsDesdeArchivo("src/test/resources/ejemploConBullets.md");
		Formateador formateadorHTML = new FormateadorHTML();
		...
		Assert.assertEquals(soloUnTituloFormateadoEsperado, itemsEntradaObtenida.get(1).getTextoFormateado(formateadorHTML));
		Assert.assertEquals(soloTextoFormateadoEsperado, itemsEntradaObtenida.get(2).getTextoFormateado(formateadorHTML));
		Assert.assertEquals(listaUnicaFormateadoEsperado, itemsEntradaObtenida.get(3).getTextoFormateado(formateadorHTML));		
	...
	public void seCreanDosListasDeItemsConBullets() throws IOException {
		...
		GeneradorItemsDesdeArchivo generadorItemsDesdeArchivo = new GeneradorItemsDesdeArchivo("src/test/resources/ejemploConMultiplesBullets.md");
		Formateador formateadorHTML = new FormateadorHTML();
