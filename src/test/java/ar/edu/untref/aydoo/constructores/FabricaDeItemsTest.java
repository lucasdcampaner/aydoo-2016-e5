...
public class FabricaDeItemsTest {
	...
	public void crearUnaSeccionConUnItemLista() {
		...
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(0).getElementosEnContenedor().get(0).getElementosEnContenedor().get(0).getClass());
	}
	...
	public void crearUnaSeccionConDosItemLista() {
		...
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(0).getElementosEnContenedor().get(0).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(0).getElementosEnContenedor().get(0).getElementosEnContenedor().get(1).getClass());
	}

	@Test
	public void crearUnaSeccionDosItemListaSeparadasPorUnTitulo() {

		listaLeida = Arrays.asList("---", "* Item lista 1", "* Item lista 2", "# Titulo1", "* Item lista 3",
				"* Item lista 4");
		...
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(0).getElementosEnContenedor().get(2).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(0).getElementosEnContenedor().get(2).getElementosEnContenedor().get(1).getClass());
	...
	public void crearDosSeccionesCadaUnaConUnaLista() {
		...
		listaLeida = Arrays.asList("---", "* Item lista 1", "* Item lista 2", "---", "* Item lista 3",
				"* Item lista 4");
		...
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(1).getElementosEnContenedor().get(0).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(1).getElementosEnContenedor().get(0).getElementosEnContenedor().get(1).getClass());
	}

	@Test
	public void crearItemsDelEjemplo1() {

		listaLeida = Arrays.asList("---", "# El titulo", "## El subtitulo", "---", "# Solo un titulo", "---",
	...
	public void crearItemsDelEjemploConBullets() {
		...
		listaLeida = Arrays.asList("---", "# El titulo", "## El subtitulo", "---", "# Solo un titulo", "---",
				"solo texto sin nada mas", "---", "* Un item de una lista", "* Otro item");
		...
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(3).getElementosEnContenedor().get(0).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(3).getElementosEnContenedor().get(0).getElementosEnContenedor().get(1).getClass());
		Assert.assertEquals("Otro item",
				listaSalida.get(3).getElementosEnContenedor().get(0).getElementosEnContenedor().get(1).getTexto());
	}

	@Test
	public void crearItemsDelEjemploConEncabezadoSinSeccion() {

		listaLeida = Arrays.asList("Encabezado", "---", "# El titulo", "## El subtitulo", "---", "# Solo un titulo",
				"---", "solo texto sin nada mas");
	...
	public void crearItemsDelEjemploConMultiplesBullets() {
		...
		listaLeida = Arrays.asList("---", "# El titulo", "## El subtitulo", "---", "# Primera lista", "* Uno", "* Dos",
				"---", "# Solo un titulo", "---", "solo texto sin nada mas", "---", "# Segunda lista", "* Tres",
		...
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(1).getElementosEnContenedor().get(1).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals("Uno",
				listaSalida.get(1).getElementosEnContenedor().get(1).getElementosEnContenedor().get(0).getTexto());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(1).getElementosEnContenedor().get(1).getElementosEnContenedor().get(1).getClass());
		Assert.assertEquals("Dos",
				listaSalida.get(1).getElementosEnContenedor().get(1).getElementosEnContenedor().get(1).getTexto());
		// Seccion 3
		Assert.assertEquals(Seccion.class, listaSalida.get(2).getClass());
		Assert.assertEquals(1, listaSalida.get(2).getElementosEnContenedor().size());
		Assert.assertEquals(Titulo.class, listaSalida.get(2).getElementosEnContenedor().get(0).getClass());
		...
		// Dentro del contenedor de listas
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(4).getElementosEnContenedor().get(1).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals("Tres",
				listaSalida.get(4).getElementosEnContenedor().get(1).getElementosEnContenedor().get(0).getTexto());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(4).getElementosEnContenedor().get(1).getElementosEnContenedor().get(1).getClass());
		Assert.assertEquals("Cuatro",
				listaSalida.get(4).getElementosEnContenedor().get(1).getElementosEnContenedor().get(1).getTexto());
		// Seccion 6
		...
		// Dentro del contenedor de listas
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(5).getElementosEnContenedor().get(0).getElementosEnContenedor().get(0).getClass());
		Assert.assertEquals("Seis",
				listaSalida.get(5).getElementosEnContenedor().get(0).getElementosEnContenedor().get(0).getTexto());
		Assert.assertEquals(ItemLista.class,
				listaSalida.get(5).getElementosEnContenedor().get(0).getElementosEnContenedor().get(1).getClass());
		Assert.assertEquals("Siete",
				listaSalida.get(5).getElementosEnContenedor().get(0).getElementosEnContenedor().get(1).getTexto());
	}
	...
	public void crearItemsDelEjemploConImagen() {
		...
		listaLeida = Arrays.asList("---", "# El titulo", "## El subtitulo", "---", "# Solo un titulo", "---",
				"solo texto sin nada mas", "---", "i: src/test/resources/winteriscoming.jpg");
		...
		Assert.assertEquals("src/test/resources/winteriscoming.jpg",
				listaSalida.get(3).getElementosEnContenedor().get(0).getTexto());
	}
